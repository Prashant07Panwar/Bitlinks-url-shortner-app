...
const about = () => {
  return (
    ...
    <section className="pb-10 pt-4  bg-transparent space-y-2 min-h-[82vh]">
        <div className="w-[80%] mx-auto px-6 text-center cursor-pointer rounded-xl shadow-md border-[1px] shadow-gray-950 bg-gray-200 py-2">
            <div className={`my-2 rounded-xl hover:text-lg px-2 shadow-md hover:shadow-md hover:shadow-purple-900 border-[1px] border-t-purple-100 border-purple-400 shadow-purple-900`}>
            ...
            <div className={`mt-6 mx-auto text-left rounded-xl hover:text-lg border-[1px] border-t-purple-100 px-2 shadow-md hover:shadow-md shadow-purple-900 hover:shadow-purple-900`}>
            ...
            <div className="mt-8 mb-2 flex flex-col items-center rounded-xl hover:text-lg border-[1px] border-t-purple-200 border-purple-100 px-2 shadow-md hover:shadow-md shadow-purple-900 hover:shadow-purple-900 text-black p-6 ">
